...
def viz_wordboxes_in_all_dlabox(image, all_gt_text_region_bbox, wordboxes_in_all_dlabox, prefix=""):
...
def reconstruct(directory, img_src_save_dir):
    ...
    for idx, file_name in tqdm(enumerate(os.listdir(directory))):
        ...
        # print(file_name)
        if os.path.isfile(os.path.join(directory, file_name)) and idx > 16: # \
            # and file_name in ["0b0e7f70-1225-4ed5-b5e2-9cc5fb9795a6.png", '0aa9adfb-378e-457a-8e29-f9e75f9611ad.png']: # and file_name == "two_col.png":
...
if __name__ == '__main__':
    ...
    log_csv_file = test_image_directory+f'_full_runtime_{process_num1}_{process_num2}_160.csv'
